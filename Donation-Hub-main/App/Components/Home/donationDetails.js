...
export default function DonationDetails({profilePhoto, profileName, profileLocation, profileDonation}){
    return (
        <View
        ...
        padding: 40
            ...
            <View style={{backgroundColor: Colors.WHITE, width: 60, height: 60,  marginTop: 25, padding: 5, borderRadius: 30}}>
